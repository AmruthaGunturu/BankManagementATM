...
class CheckingAccount(Account):
    def __init__(self, cust_id, deposit_amount):
        ...
        # returns the whole number from amount as integer
        self.amount_whole = int(self.numstr[:self.numstr.find('.')])

        # returns the decimal value from amount as integer
...
if __name__ == '__main__':
    ...
    def initialise_objects():
        global raju_checking, amrutha_business, amrutha_savings, master_list

        raju_checking = CheckingAccount(1, 2567.50)
        amrutha_savings = SavingsAccount(2, 12890.01)
        amrutha_business = BusinessAccount(2, 14500.40)

        master_list = [[raju_checking, 1, 1], [amrutha_savings, 2, 2], [amrutha_business, 2, 3]]
